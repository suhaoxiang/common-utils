...
public class IdCardUtil {
    ...
    public static boolean isIdNumber(String idNumber) {
        ...
        if (idNumber.length() == CHINA_ID_MIN_LENGTH) {
            String regex = "^[1-9]\\d{5}\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{2}[0-9]$";
    ...
    public static String getBirthdayStr(String idNumber) {
        ...
        if (idNumber.length() == CHINA_ID_MIN_LENGTH) {
            idNumber = convertIdNumber15To18(idNumber);
        }
     ...
     * @return 0=未知, 1=男, 2=女
     */
    public static int getGenderInt(String idNumber) {
        String genderStr = getGenderStr(idNumber);

        if ("".equalsIgnoreCase(genderStr)) {
            return 0;
        }

        return "男".equalsIgnoreCase(genderStr) ? 1 : 2;
    }
     ...
     * @return "","男","女"
     */
    public static String getGenderStr(String idNumber) {
    ...
    private static boolean validateIdNumber18(String idNumber) {
        if (idNumber.length() == CHINA_ID_MAX_LENGTH) {
            ...
            return code18.equalsIgnoreCase(checkCode);
        }
     ...
     * 将15位身份证号转18位
     *
     * @param idNumber15 15位身份证号码
     * @return 18位的身份证号
     */
    private static String convertIdNumber15To18(String idNumber15) {
        if (idNumber15.length() != CHINA_ID_MIN_LENGTH) {
            return idNumber15;
        }

        // 15位身份证号码在生日字段加上年19变成17位
        String idNumber17 = idNumber15.substring(0, 6) + "19" + idNumber15.substring(6);

        // 17位加权求和,计算第18位上的数字
        int powerSum = getPowerSum(idNumber17);
        String number18 = getCheckCode18(powerSum);

        return idNumber17 + number18;
    }


    public static void main(String[] args) {
        String idNumber = "622826199009234316";

        System.out.println("15位转18位结果:" + convertIdNumber15To18(idNumber));
        ...
        System.out.println("性别：" + IdCardUtil.getGenderStr(idNumber));
